...
public class Calculate {
    ...
    public static final class CalculateBuilder {
        ...
        public CalculateBuilder withBtn_percent(Button btn_zf) {
            this.btn_zf = btn_zf;
            return this;
        }

        public CalculateBuilder withBtn_sqrt(Button btn_sqrt) {
            this.btn_sqrt = btn_sqrt;
            return this;
        }
        ...
        public Calculate build() {
            ...
            calculate.btn_sqrt=this.btn_sqrt;
            ...
            calculate.btn_zf.setOnClickListener(clickListener);
            calculate.btn_equal.setOnClickListener(clickListener);
            calculate.btn_sqrt.setOnClickListener(clickListener);
            return calculate;
